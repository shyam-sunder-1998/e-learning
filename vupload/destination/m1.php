  ...
  <ul class="nav navbar-nav">
   <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">I Year<span class="caret"></span></a>
     <ul class="dropdown-menu" role="menu">
      <li><a href="http://localhost/vupload/destination/eng.php">English</a></li>
      <li><a href="http://localhost/vupload/destination/chem1.php">Chemistry-1</a></li>
      <li><a href="http://localhost/vupload/destination/m1.php">Maths-1</a></li>
      <li class="divider"></li>
      <li><a href="http://localhost/vupload/destination/pds-1.php">Pds-1</a></li>
   ...
   <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">II Year<span class="caret"></span></a>
     <ul class="dropdown-menu" role="menu">
      <li><a href="http://localhost/vupload/destination/dbms.php">DBMS</a></li>
   ...
   <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">III Year<span class="caret"></span></a>
     <ul class="dropdown-menu" role="menu">
...
$query=$sql->query( "SELECT description,filename,file_extension FROM user1 where sub='sem1-3'" );
